...
import net.piinut.voidophobia.block.blockEntity.renderer.*;
...
public class VoidophobiaClient implements ClientModInitializer {
    ...
    private void registerBlockEntityRenderers(){
        ...
        BlockEntityRendererRegistry.register(ModBlockEntities.LASER_TRANSMITTER, LaserTransmitterBlockEntityRenderer::new);
        BlockEntityRendererRegistry.register(ModBlockEntities.LASERWORK_TABLE, LaserworkTableBlockEntityRenderer::new);
