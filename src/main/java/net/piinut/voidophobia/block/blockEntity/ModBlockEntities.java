...
public class ModBlockEntities {
    ...
    public static BlockEntityType<VuxFurnaceBlockEntity> VUX_FURNACE;
    ...
    public static void registerAll(){
        ...
        VUX_FURNACE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Voidophobia.MODID, "vux_furnace")
                , FabricBlockEntityTypeBuilder.create(VuxFurnaceBlockEntity::new, ModBlocks.VUX_FURNACE).build(null));
