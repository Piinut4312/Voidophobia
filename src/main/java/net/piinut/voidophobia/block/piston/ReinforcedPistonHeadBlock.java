...
public class ReinforcedPistonHeadBlock extends FacingBlock {
    ...
    public ReinforcedPistonHeadBlock(Settings settings) {
        super(settings);
    ...
    private boolean isAttached(BlockState headState, BlockState pistonState) {
        Block block = headState.get(TYPE) == PistonType.DEFAULT ? ModBlocks.REINFORCED_PISTON : ModBlocks.REINFORCED_STICKY_PISTON;
        return pistonState.isOf(block) && pistonState.get(ReinforcedPistonBlock.EXTENDED) && pistonState.get(FACING) == headState.get(FACING);
    }
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return this.isAttached(state, blockState) || blockState.isOf(ModBlocks.MOVING_REINFORCED_PISTON) && blockState.get(FACING) == state.get(FACING);
    }
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(state.get(TYPE) == PistonType.STICKY ? ModBlocks.REINFORCED_STICKY_PISTON : ModBlocks.REINFORCED_PISTON);
    }
